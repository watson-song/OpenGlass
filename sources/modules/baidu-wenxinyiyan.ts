...
export async function gptRequest(systemPrompt: string, userPrompt: string) {
    try {
        const response = await axios.post("https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat/ernie-speed-128k?access_token=24.d0e9c8cd5d48bb795002dbfbc60589db.2592000.1719857801.282335-77433944", {
            messages: [
